<x-apps-layout title="Create Basis Kasus">
    @push('styles')
    @endpush
                        ...
                        <div class="p-4 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                            <div class="flex flex-wrap -mx-3">
                                <div class="flex items-center flex-none w-1/2 max-w-full px-3">
                                    <h6 class="mb-0">Create New Basis Kasus</h6>
                                </div>
                            </div>
                        </div>
                        <div class="flex-auto p-4">
                            <form role="form" method="POST" action="{{ route('basiskasus.store') }}">
                                @csrf
                                <div class="flex flex-wrap -mx-3">
                                    ...
                                    <div class="max-w-full px-3 md:w-1/2 md:flex-none">
                                        ...
                                        <div class="mb-4">
                                            <input type="text" id="namaBasisKasus" name="namaBasisKasus"
                                                :value="old('namaBasisKasus')" required autofocus
                                    ...
                                    <div class="max-w-full px-3 mb-6 md:mb-0 md:w-1/2 md:flex-none">
                                        ...
                                        <div class="mb-4">
                                            <textarea id="detailBasisKasus" name="detail_basis_kasus" required autofocus
                                                class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow"
                                                placeholder="Detail Basis Kasus" aria-label="id" aria-describedby="id-addon" style="height: 7.14em;"></textarea>
                                        ...
                                        <div class="mb-4">
                                            <select id="gejala" name="gejala[]" required autofocus multiple
                                                ...
                                                @foreach ($gejalaOptions as $gejala)
                                                    <option value="{{ $gejala->id }}">{{ $gejala->nama_gejala }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            @error('gejala')
