<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="current_password" :value="__('Current Password')" class="mb-2 ml-1 font-bold text-xs text-slate-700" />
        ...
        <div>
            <x-input-label for="password" :value="__('New Password')" class="mb-2 ml-1 font-bold text-xs text-slate-700" />
